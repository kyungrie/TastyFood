    ...
    <ul id="nav-menu"
        ...
        <?php if(Auth::check()): ?>
            <?php if(Auth::user()->type == 'admin'): ?>
                <li><a class="text-xl font-semibold text-white md:px-3 md:py-2 md:rounded-md md:hover:text-white md:hover:bg-gray-500" href="/admin">DASHBOARD (<?php echo e(Auth::user()->name); ?>)</a></li>
            <?php endif; ?>
        ...
        <?php else: ?>
            ...
            <li><a class="text-xl font-semibold text-white md:px-3 md:py-2 md:rounded-md md:hover:text-white md:hover:bg-gray-500" href="/register">REGISTER</a></li>
        <?php endif; ?>
    </ul>
...
<div
    class="flex flex-row justify-start items-center px-5 py-20 md:p-20 w-[100vw] h-[50vh] md:h-[80vh] -mt-[4rem] md:-mt-[10rem] bg-cover" style="background-image: url('<?php echo e(asset('images/group-70.png')); ?>')">
    <h1 class="font-extrabold text-white text-[4rem]"><?php echo e($title); ?></h1>
</div>
<?php /**PATH /home/kyungrie/TastyFood/resources/views/components/navbar.blade.php ENDPATH**/ ?>