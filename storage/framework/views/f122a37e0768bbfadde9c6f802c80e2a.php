    ...
    <div class="p-4 py-6 mx-auto w-full max-w-screen-xl lg:py-8">
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                ...
                <img src="<?php echo e(asset('images/001-facebook.png')); ?>" class="size-[2rem]" alt="Facebook-icon"> <img
                    src="<?php echo e(asset('images/002-twitter.png')); ?>" class="size-[2rem] relative -top-8 left-10"
                    alt="Twitter-icon">
            </div>
                    ...
                    <ul class="font-medium text-white">
                        <li class="mb-4">
                            <p class="relative -top-4 left-6 hover:text-blue-500"><img
                                    src="<?php echo e(asset('images/ic_markunread_24px.png')); ?>"
                        ...
                        <li>
                            <p class="relative -top-6 left-6 hover:text-blue-500"><img
                                    src="<?php echo e(asset('images/ic_call_24px.png')); ?>"
                        ...
                        <li>
                            <p class="relative left-6 -top-9 hover:text-blue-500"><img
                                    src="<?php echo e(asset('images/ic_place_24px.png')); ?>"
...
<?php /**PATH /home/kyungrie/TastyFood/resources/views/components/footer.blade.php ENDPATH**/ ?>