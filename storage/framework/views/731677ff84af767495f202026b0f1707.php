...
<?php endif; ?>
<form class="flex flex-col gap-5 px-40 py-28" action="/admin/gallery" method="post" enctype="multipart/form-data">
    <?php echo method_field('PUT'); ?>
    <?php echo csrf_field(); ?>
    <input type="hidden" name="id" value="<?php echo e($galleries->id); ?>">
    <label for="">Title</label>
    <input type="text" name="title" value="<?php echo e($galleries->title); ?>"
    ...
    <input type="file" name="picture" value="<?php echo e($galleries->picture); ?>"
        class="block px-2 py-1.5 w-full text-gray-600 rounded-md border-2 form-input placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
...
<?php endif; ?>
<?php /**PATH /home/kyungrie/TastyFood/resources/views/admin/gallery/edit.blade.php ENDPATH**/ ?>