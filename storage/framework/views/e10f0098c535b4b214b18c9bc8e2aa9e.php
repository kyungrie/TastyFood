...
<?php endif; ?>
        <div class="p-20 bg-white rounded-xl shadow-xl">
            ...
            <form method="post" action="/register">
                <?php echo csrf_field(); ?>
                <label>
                    <input type="text" name="username" placeholder="Username" required value="<?php echo e(old('username')); ?>"
...
<?php endif; ?><?php /**PATH /home/kyungrie/TastyFood/resources/views/register.blade.php ENDPATH**/ ?>