<nav id="navbar"
    ...
    <ul id="nav-menu"
        ...
        <?php if(Auth::user()->type == 'admin'): ?>
            <li><a class="text-sm font-semibold md:px-3 md:py-2 md:rounded-md md:hover:text-white md:hover:bg-gray-500" href="/admin">DASHBOARD (<?php echo e(Auth::user()->name); ?>)</a></li>
        <?php endif; ?>
    ...
    <?php else: ?>
        ...
        <li><a class="text-sm font-semibold md:px-3 md:py-2 md:rounded-md md:hover:text-white md:hover:bg-gray-500" href="/register">REGISTER</a></li>
    <?php endif; ?>
    </ul>
...
<?php /**PATH /home/kyungrie/TastyFood/resources/views/components/navbar-white.blade.php ENDPATH**/ ?>